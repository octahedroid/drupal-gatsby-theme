...
<Meta
  ...
  component={Grid}
  subcomponents={{ GridColumn: Grid.Column }}
/>
...
the grid will have from the third breakpoint onwards. The first and second breakpoint will have 1 column and two columns respectively.
...
This will place it for the first breakpoint, and since there are no other declarations, it will apply for the next breakpoints as well.
